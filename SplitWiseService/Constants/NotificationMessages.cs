...
public static class NotificationMessages
{
    ...
    public const string SettleBeforeRemove = "Expenses must be settled before removing the {0}.";

    // Export
    public const string CanNotExportEmptyList = "The {0} list is empty, so there is nothing to export.";

    // Group
    public const string FriendAddedToGroup = "Selected friends have been successfully added.";
    ...
    public const string NoGroupsForUser = "You are not currently associated with any group. To add a group expense, please create a new group first.";
