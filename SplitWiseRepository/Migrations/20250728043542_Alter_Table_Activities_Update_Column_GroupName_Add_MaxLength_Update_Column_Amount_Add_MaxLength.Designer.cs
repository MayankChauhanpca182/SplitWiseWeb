...
namespace SplitWiseRepository.Migrations
{
    ...
    [Migration("20250728043542_Alter_Table_Activities_Update_Column_GroupName_Add_MaxLength_Update_Column_Amount_Add_MaxLength")]
    partial class Alter_Table_Activities_Update_Column_GroupName_Add_MaxLength_Update_Column_Amount_Add_MaxLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SplitWiseRepository.Models.Activity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SplitWiseRepository.Models.Activity", b =>
                {
                    b.HasOne("SplitWiseRepository.Models.Expense", "Expense")
                        .WithMany()
                    ...
                    b.HasOne("SplitWiseRepository.Models.User", "PerformedOnUser")
                        .WithMany()
                        .HasForeignKey("PerformedOnId");
            ...
            modelBuilder.Entity("SplitWiseRepository.Models.Expense", b =>
                {
                    ...
                    b.HasOne("SplitWiseRepository.Models.Category", "ExpenseCategory")
                        .WithMany()
